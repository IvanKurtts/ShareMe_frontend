  ...
  return (
    <div className="m-2">
      <div
        ...
        className=" flex items-center bg-gray-200 relative cursor-zoom-in w-auto hover:shadow-lg rounded-lg overflow-hidden transition-all duration-500 ease-in-out"
      >
        <img
          className="w-full"
          alt="user-post"
